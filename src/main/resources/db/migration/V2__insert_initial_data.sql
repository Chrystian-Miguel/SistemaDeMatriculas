...
VALUES ('c1111111-2222-3333-4444-555555555555', 'Full Stack Junior Development',
        'Intensive training on Java, Spring Boot, and Frontend technologies.'),
       ('c2222222-2222-3333-4444-555555555555', 'Software Engineering',
...
VALUES ('d1111111-2222-3333-4444-555555555555', 'Algorithms and Logic', 80, 'c1111111-2222-3333-4444-555555555555'),
...
VALUES ('f1111111-2222-3333-4444-555555555555', 'CLASS-2026-ALG-A', 30, 29, 'OPEN',
        'd1111111-2222-3333-4444-555555555555'),
       ('f2222222-2222-3333-4444-555555555555', 'CLASS-2026-WEB-B', 2, 2, 'OPEN',
        'd2222222-2222-3333-4444-555555555555'),
       ('f3333333-2222-3333-4444-555555555555', 'CLASS-2026-WEB-CLOSED', 20, 20, 'CLOSED',
        'd2222222-2222-3333-4444-555555555555');

-- Initial Enrollments
INSERT INTO enrollment (id, student_id, class_section_id, status)
VALUES ('e1111111-2222-3333-4444-555555555555', 'a1111111-2222-3333-4444-555555555555',
        'f1111111-2222-3333-4444-555555555555', 'CONFIRMED'),
       ('e2222222-2222-3333-4444-555555555555', 'a2222222-2222-3333-4444-555555555555',
        'f2222222-2222-3333-4444-555555555555', 'PENDING');